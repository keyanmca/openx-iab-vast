			...
			if(displayEvent.customData.adSlotPosition != undefined) {
				...
				if(nonLinearVideoAd.isHtmlCodeBlock()) {
					if(nonLinearVideoAd.hasAccompanyingVideoAd()) {
						html = "<p align='left'><a href=\"javascript:openx.triggerEvent('" + _model.name + "', { type:'showLinearAd', slotId: " + displayEvent.customData.adSlotKey + ", adIndex:" + displayEvent.customData.adSlotAssociatedStreamIndex + " });\">";
					...
					if(nonLinearVideoAd.hasAccompanyingVideoAd()) {
						html = "<a href=\"javascript:openx.triggerEvent('" + _model.name + "', { type:'showLinearAd', slotId: " + displayEvent.customData.adSlotKey + ", adIndex:" + displayEvent.customData.adSlotAssociatedStreamIndex + " });\">";
