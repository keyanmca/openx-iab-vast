 ...
 */
 package com.bouncingminds.flowplayer.regions {
	...
	public class RegionsConfig extends BaseRegionConfig {
		...
		private var _adStreamerPluginName:String = "openXAdStreamer";
		...
		public function set adStreamerPluginName(adStreamerPluginName:String):void {
			_adStreamerPluginName = adStreamerPluginName;	
		}

		public function get adStreamerPluginName():String {
			return _adStreamerPluginName;	
		}
